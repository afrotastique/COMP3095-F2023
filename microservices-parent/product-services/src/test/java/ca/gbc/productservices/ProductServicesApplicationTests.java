...
public class ProductServicesApplicationTests extends AbstractContainerBaseTest{
    ...
    private String convertObjectToJsonString(List<ProductResponse> productList) throws Exception{
